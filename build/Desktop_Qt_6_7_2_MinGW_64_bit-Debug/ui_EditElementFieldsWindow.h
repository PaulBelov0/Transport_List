...
public:
    ...
    void setupUi(QDialog *EditElementFieldsWindow)
    {
        ...
        labelSpecialFieldFirst->setGeometry(QRect(0, 290, 91, 31));
        ...
        labelSpecialFieldSecond->setGeometry(QRect(0, 330, 91, 31));
